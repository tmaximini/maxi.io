  ...
  <UsesWrapper>
    ...
    <p>
      <ul>
        <li>
          ...
          <Link to="https://code.visualstudio.com/">VS Code</Link> with the{" "}
          <b>Default Dark+ Theme</b>. I do nearly all my coding in it.
        </li>
        <li>
          From time to time I still go back to{" "}
          <Link to="https://www.sublimetext.com/3">Sublime Text 3</Link> ot fire
          up <Link to="https://www.jetbrains.com/webstorm/">Webstorm</Link>.
        </li>
        <li>
    ...
    <ul>
      <li>
        ...
        <Link to="https://1password.com/">1Password</Link> which keeps track of
        all my passwords.
      </li>
      <li>
        I use <Link to="https://todoist.com/app">Todoist</Link> to keep track of
        my tasks and daily chores.
      </li>
      <li>
      ...
      <li>
        <Link to="https://notion.so">Notion</Link> is another note-taking and
      ...
      <li>
        I love <Link to="https://docs.docker.com/docker-for-mac/">Docker</Link>{" "}
      ...
      <li>
        <Link to="https://justgetflux.com/">Flux</Link> improves the quality of
        my sleep when working late on my computer.
      </li>
    </ul>
    <h2>Desk Setup</h2>
    <ul>
      ...
      <li>
        Since this year I am using a Macbook pro 16". It is the best computer I
        ever owned.
      </li>
      <li>
        My monitor is the{" "}
      ...
      <li>
        I use the{" "}
        <Link to="https://www.therooststand.com/">roost laptop stand</Link> for
        my Laptop at home and when I travel.
      </li>
